                        ...
                        <form>
                            <Grid container spacing={3}>
                                ...
                                <Grid xs={6} sm={6} item style={{ marginTop: 20 }} >
                                    <TextField inputProps={{ readOnly: true }} value={balance} placeholder="Total balance" label="Total Balance" variant="outlined" fullWidth required />
                                </Grid>
                                ...
                                <Grid xs={6} sm={6} item style={{ marginTop: 20 }} >
                                    <TextField value={amount} onChange={handleAmount} focused variant="outlined" id="amount" label="withdraw Amount" required fullWidth InputLabelProps={{ shrink: true }} />
